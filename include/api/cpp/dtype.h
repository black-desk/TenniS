...
namespace ts
{
  namespace api
  {
    ...
    template <>
    struct dtype<TS_VOID> {
        using declare = void;
    };
    template <>
    struct dtype<TS_INT8> {
        using declare = int8_t;
    };
    template <>
    struct dtype<TS_UINT8> {
        using declare = uint8_t;
    };
    template <>
    struct dtype<TS_INT16> {
        using declare = int16_t;
    };
    template <>
    struct dtype<TS_UINT16> {
        using declare = uint16_t;
    };
    template <>
    struct dtype<TS_INT32> {
        using declare = int32_t;
    };
    template <>
    struct dtype<TS_UINT32> {
        using declare = uint32_t;
    };
    template <>
    struct dtype<TS_INT64> {
        using declare = int64_t;
    };
    template <>
    struct dtype<TS_UINT64> {
        using declare = uint64_t;
    };
    template <>
    struct dtype<TS_FLOAT32> {
        using declare = float;
    };
    template <>
    struct dtype<TS_FLOAT64> {
        using declare = double;
    };
    template <>
    struct dtype<TS_CHAR8> {
        using declare = char;
    };

    template <typename T>
    struct dtypeid {
        static const ts_DTYPE id = TS_VOID;
    };
    ...
    template <>
    struct dtypeid<int8_t> {
        static const ts_DTYPE id = TS_INT8;
    };
    template <>
    struct dtypeid<uint8_t> {
        static const ts_DTYPE id = TS_UINT8;
    };
    template <>
    struct dtypeid<int16_t> {
        static const ts_DTYPE id = TS_INT16;
    };
    template <>
    struct dtypeid<uint16_t> {
        static const ts_DTYPE id = TS_UINT16;
    };
    template <>
    struct dtypeid<int32_t> {
        static const ts_DTYPE id = TS_INT32;
    };
    template <>
    struct dtypeid<uint32_t> {
        static const ts_DTYPE id = TS_UINT32;
    };
    template <>
    struct dtypeid<int64_t> {
        static const ts_DTYPE id = TS_INT64;
    };
    template <>
    struct dtypeid<uint64_t> {
        static const ts_DTYPE id = TS_UINT64;
    };
    template <>
    struct dtypeid<float> {
        static const ts_DTYPE id = TS_FLOAT32;
    };
    template <>
    struct dtypeid<double> {
        static const ts_DTYPE id = TS_FLOAT64;
    };
    template <>
    struct dtypeid<char> {
        static const ts_DTYPE id = TS_CHAR8;
    };
  }  // namespace api
}  // namespace ts
