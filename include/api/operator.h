...
extern "C" {
   ...
   */
  TENNIS_C_API ts_Tensor *ts_OperatorParams_get(
   ...
   */
  typedef void ts_Operator_init(
    void *op, const ts_OperatorParams *dict, ts_OperatorContext *context);
   ...
   */
  typedef ts_bool ts_Operator_init_ex(
    void *op, const ts_OperatorParams *dict, ts_OperatorContext *context);
   ...
   */
  typedef ts_Tensor *ts_Operator_infer(
    void *op, int32_t argc, ts_Tensor **argv, ts_OperatorContext *context);
   ...
   */
  typedef ts_Tensor *ts_Operator_run(
    void *op, int32_t argc, ts_Tensor **argv, ts_OperatorContext *context);
   ...
   */
  TENNIS_C_API void ts_Operator_ThrowV2(
 ...
 */
#define TS_C_THROW(message) ts_Operator_ThrowV2((message), __FILE__, __LINE__)
