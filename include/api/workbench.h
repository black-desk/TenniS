...
extern "C" {
   ...
   */
  TENNIS_C_API ts_Workbench *ts_Workbench_Load(
   ...
   */
  TENNIS_C_API ts_bool ts_Workbench_input(
    ts_Workbench *workbench, int32_t i, const ts_Tensor *tensor);
   ...
   * @return false if failed.
   */
  TENNIS_C_API ts_bool ts_Workbench_input_by_name(
    ts_Workbench *workbench, const char *name, const ts_Tensor *tensor);

  /**
   * Run network. then get output by ts_Workbench_output or
   * ts_Workbench_output_by_name
   * @param workbench instance of workbench
   * @return false if failed.
   */
  ...
  ts_Workbench_output(ts_Workbench *workbench, int32_t i, ts_Tensor *tensor);
   ...
   * @return false if failed.
   */
  TENNIS_C_API ts_bool ts_Workbench_output_by_name(
    ts_Workbench *workbench, const char *name, ts_Tensor *tensor);
   ...
   * @return false if failed.
   */
  TENNIS_C_API ts_bool ts_Workbench_set_computing_thread_number(
    ts_Workbench *workbench, int32_t number);
   ...
   * @return false if failed.
   */
  TENNIS_C_API ts_bool ts_Workbench_bind_filter(
    ts_Workbench *workbench, int32_t i, const ts_ImageFilter *filter);
   ...
   * @return false if failed.
   */
  TENNIS_C_API ts_bool ts_Workbench_bind_filter_by_name(
    ts_Workbench *workbench, const char *name, const ts_ImageFilter *filter);
   ...
   */
  TENNIS_C_API ts_bool
  ts_Workbench_setup(ts_Workbench *workbench, const ts_Program *program);
   ...
   * @return new reference, NULL if failed.
   */
  TENNIS_C_API ts_Program *ts_Workbench_compile(
    ts_Workbench *workbench, const ts_Module *module);
   ...
   * @return false if failed.
   */
  TENNIS_C_API ts_bool ts_Workbench_run_hook(
    ts_Workbench *workbench, const char **node_names, int32_t len);
   ...
   * 2. "--filter" Default OFF, filter const values, set values to zero which
   * smaller than FLT_EPSILON
   */
  TENNIS_C_API ts_Workbench *ts_Workbench_Load_v2(
    const ts_Module *module, const ts_Device *device, const char *options);
   ...
   * smaller than FLT_EPSILON
   */
  TENNIS_C_API ts_Program *ts_Workbench_compile_v2(
    ts_Workbench *workbench, const ts_Module *module, const char *options);
   ...
   * @return false if failed
   */
  TENNIS_C_API ts_bool ts_Workbench_set_operator_param(
    ts_Workbench    *workbench,
   ...
   *     {"device": "gpu:0", "thread": 4, "shared": "97.8MB", "memory":
   * {"cpu:0": "32B", "gpu:0": "7.3MB"}}
   */
   ...
   */
  TENNIS_C_API ts_bool
  ts_Workbench_set_cpu_mode(ts_Workbench *workbench, ts_CpuPowerMode mode);
