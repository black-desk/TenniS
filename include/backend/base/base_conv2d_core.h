  ...
  namespace base
  {
    class Conv2DCore {
      public:
        ...
        virtual void conv2d(
          ...
          Tensor           &out,
          Stack            &stack) {
          TS_LOG_ERROR << "What a Terrible Failure: not implement conv2d core."
                       << eject;
        }
    };
    ...
    class Conv2DWithCore : public Conv2D {
      public:
        ...
        Conv2DWithCore() { m_core = std::make_shared<Core>(); }
    ...
    class PackedConv2DWithCore : public Conv2D {
      public:
        ...
        PackedConv2DWithCore() { m_core = std::make_shared<Core>(); }
