  ...
  namespace base
  {
    class Conv2DTransposeCore {
      public:
         ...
         * @param out
         * @param stack
         * Notice the input_channels and output_channels swapped in weights, as
         * it is the backward for Conv2D
         */
        virtual void conv2d_transpose(
          const Tensor     &x,
          ...
          Stack            &stack) {
          TS_LOG_ERROR
            << "What a Terrible Failure: not implement transpose conv2d core."
            << eject;
        }
        ...
        virtual void conv2d_transpose(
          ...
          this->conv2d_transpose(
            x, padding, padding_value, w, stride, dilation, format, out, stack);
        }
    };
    ...
    class Conv2DTransposeWithCore : public Conv2DTranspose {
      public:
        ...
        Conv2DTransposeWithCore() { m_core = std::make_shared<Core>(); }
    ...
    class PackedConv2DTransposeWithCore : public Conv2DTranspose {
      public:
        ...
        PackedConv2DTransposeWithCore() { m_core = std::make_shared<Core>(); }
