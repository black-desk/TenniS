  ...
  namespace base
  {
    class Conv2DWinograd : public OperatorOnDevice {
      public:
        ...
        virtual void conv2d_tranform_kernel(
          WinogradConv2DMode winograd_mode,
          const Tensor      &kernel,
          Tensor            &kernel_transformed) = 0;

        virtual void conv2d_winograd(
          const Tensor      &x,
          WinogradConv2DMode winograd_mode,
          ...
          Conv2DFormat       format,
          Tensor            &out,
          bool               kernel_transformed) = 0;
        // virtual void conv2d_winograd(const Tensor &x, WinogradConv2DMode
        // winograd_mode,
