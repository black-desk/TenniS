  ...
  namespace base
  {
    class Gemm : public OperatorOnDevice {
      public:
        ...
        /**
         *
         * @param A The shape of A should be (M, K) if transA is 0, or (K, M) if
         * transA is non-zero.
         * @param B The shape of B should be (K, N) if transB is 0, or (N, K) if
         * transB is non-zero.
         * @param C The shape of C should be unidirectional broadcastable to (M,
         * N), means (1 or M, 1 or N).
         * @param K
         * @param alpha
         * @param beta
         * @param transA
