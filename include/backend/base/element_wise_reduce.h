...
namespace ts
{
  class ElementWiseReduce : public OperatorOnDevice {
    public:
       ...
       * give in constructor
       */
      virtual void reduce_with_broadcast(
        const Tensor &lhs, const Tensor &rhs, Tensor &out) = 0;
       ...
       * give in constructor
       */
      virtual void reduce_with_same_shape(
       ...
       * give in constructor
       */
      virtual void reduce_with_scalar(
        const Tensor &lhs, const Tensor &rhs, Tensor &out);
       ...
       * give in constructor
       */
      virtual void reduce_with_bias_cross(
        const Tensor &lhs, const Tensor &rhs, Tensor &out, int dim);
       ...
       * give in constructor
       */
      virtual void reduce_with_scalar_cross(
        const Tensor &lhs, const Tensor &rhs, Tensor &out);
