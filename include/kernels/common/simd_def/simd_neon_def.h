...
inline _simd_int32x4x2 _simd_int32x4x2_set(
  ...
  res.val [0]                 = vld1q_s32(array_0);
  res.val [1]                 = vld1q_s32(array_1);
  return std::move(res);
...
inline _simd_f32x4 _simd_f32x4_load(const _simd_f32 *p) { return vld1q_f32(p); }
...
inline void _simd_f32x4_store(_simd_f32 *p, _simd_f32x4 m) { vst1q_f32(p, m); }
