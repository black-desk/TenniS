...
inline _simd_int32x4 _simd_int32x4_set(
  _simd_int32 a, _simd_int32 b, _simd_int32 c, _simd_int32 d) {
...
inline _simd_int32x4x2 _simd_int32x4x2_set(
  _simd_int32 a,
  _simd_int32 b,
  _simd_int32 c,
  _simd_int32 d,
...
inline _simd_int32x4x2 _simd_int32x4x2_add(
  const _simd_int32x4x2 &lhs, const _simd_int32x4x2 &rhs) {
  _simd_int32x4x2 res;
...
inline _simd_int32x4x2 _simd_int32x4x2_sub(
  const _simd_int32x4x2 &lhs, const _simd_int32x4x2 &rhs) {
  _simd_int32x4x2 res;
...
inline _simd_f32x4 _simd_f32x4_set(
  _simd_f32 a, _simd_f32 b, _simd_f32 c, _simd_f32 d) {
...
inline void _simd_f32x4_transpose4x4(
  _simd_f32x4 &q0, _simd_f32x4 &q1, _simd_f32x4 &q2, _simd_f32x4 &q3) {
  _MM_TRANSPOSE4_PS(q0, q1, q2, q3);
}

inline _simd_f32x4 _simd_f32x4_fmadd(
  const _simd_f32x4 &q0, const _simd_f32x4 &q1, const _simd_f32x4 &q2) {
#  ifdef TS_USE_FMA
...
inline _simd_f32x4 _simd_f32x4_fmadd(
  const _simd_f32x4 &q0,
  const _simd_f32x4 &q1,
  const _simd_f32x4 &q2,
  const int          index) {
#  ifdef TS_USE_FMA
...
inline _simd_f32x4 _simd_f32x4_concat(
  const _simd_f32x4 &q0, const _simd_f32x4 &q1, const int index) {
  if (index == 0) return q0;
  float res [4];
  for (int i = index; i < 4; i++) { res [i - index] = *(((float *)&q0) + i); }
...
inline _simd_f32x4 _simd_f32x4_interval_load(
  const _simd_f32 *p, const int inc) {
  const _simd_f32 *a = p;
...
inline _simd_f32x4x2 _simd_f32x4x2_set(
  _simd_f32 a,
  _simd_f32 b,
  _simd_f32 c,
  _simd_f32 d,
...
inline _simd_f32x4x2 _simd_f32x4x2_add(
  const _simd_f32x4x2 &lhs, const _simd_f32x4x2 &rhs) {
  _simd_f32x4x2 res;
...
inline _simd_f32x4x2 _simd_f32x4x2_sub(
  const _simd_f32x4x2 &lhs, const _simd_f32x4x2 &rhs) {
  _simd_f32x4x2 res;
...
inline _simd_f32x4x2 _simd_f32x4x2_mul(
  const _simd_f32x4x2 &lhs, const _simd_f32x4x2 &rhs) {
  _simd_f32x4x2 res;
...
inline _simd_f32x4x2 _simd_f32x4x2_div(
  const _simd_f32x4x2 &lhs, const _simd_f32x4x2 &rhs) {
  _simd_f32x4x2 res;
...
inline _simd_f32x4 _simd_f32x4x2_index(
  const _simd_f32x4x2 &src, const int index) {
  return src.val [index];
}

inline _simd_f32x4x2 _simd_f32x4x2_fmadd(
  const _simd_f32x4x2 &q0, const _simd_f32x4x2 &q1, const _simd_f32x4x2 &q2) {
  _simd_f32x4x2 res;
#  ifdef TS_USE_FMA
...
inline _simd_f32x4x2 _simd_f32x4x2_interval_load(
  const _simd_f32 *p, const int inc) {
  _simd_f32x4x2    res;
...
inline _simd_f32x4x3 _simd_f32x4x3_set(
  _simd_f32 a,
  _simd_f32 b,
  _simd_f32 c,
  _simd_f32 d,
...
inline void _simd_f32x4x3_store(
  _simd_f32 *p, const _simd_f32x4x3 &m, int index) {
...
inline _simd_f32x4x3 _simd_f32x4x3_interval_load(const _simd_f32 *p, int inc) {
  _simd_f32x4x3    res;
  const _simd_f32 *a0 = p;
  const _simd_f32 *b0 = p + 1;
  const _simd_f32 *c0 = p + 2;
  const _simd_f32 *a1 = a0 + inc;
  const _simd_f32 *b1 = b0 + inc;
  const _simd_f32 *c1 = c0 + inc;
  const _simd_f32 *a2 = a1 + inc;
  const _simd_f32 *b2 = b1 + inc;
  const _simd_f32 *c2 = c1 + inc;
  const _simd_f32 *a3 = a2 + inc;
  const _simd_f32 *b3 = b2 + inc;
  const _simd_f32 *c3 = c2 + inc;
...
// concat
inline _simd_f32x4x3 _simd_concat(
  const _simd_f32x4 &q0, const _simd_f32x4 &q1, const _simd_f32x4 &q2) {
  _simd_f32x4x3 res;
  res.val [0] = q0;
  res.val [1] = q1;
