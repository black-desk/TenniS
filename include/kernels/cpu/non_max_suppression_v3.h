...
namespace ts
{
  namespace cpu
  {
    class Non_Max_Suppression_V3 :
      public OperatorOnCPU<base::Non_Max_Suppression_V3> {
      public:
        using self   = Non_Max_Suppression_V3;
        using supper = OperatorOnCPU<base::Non_Max_Suppression_V3>;

        void non_max_suppression_v3(
          const Tensor &x, const Tensor &scores, Tensor &out) override;
    };
  }  // namespace cpu
}  // namespace ts
