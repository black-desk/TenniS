...
namespace ts
{
  namespace bubble
  {
     ...
     */
    TS_DEBUG_API Node
    param(const std::string &name, DTYPE dtype, const Shape &shape);
   ...
   */
  TS_DEBUG_API size_t serialize_nodes(
    StreamWriter &stream, const std::vector<Node> &nodes, size_t base = 0);
