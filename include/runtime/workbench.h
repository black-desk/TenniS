...
namespace ts
{
  class TS_DEBUG_API Workbench : public SetupContext<Workbench> {
    public:
      ...
      /**
       * This API push input to stack, then run online, the inst return size, is
       * given by doc
       * @param inst
       * @param input
       */
       ...
       * @param args
       * @return
       * This function will keep ready stack, there will be nothing happen after
       * launch, call launch_online inner
       */
      std::vector<Tensor> launch_offline(
       ...
       * @return
       * This function will keep ready stack, there will be nothing happen after
       * launch call other launch_offline inner
       */
      std::vector<Tensor> launch_offline(
    ...
    private:
      ...
      // std::vector<Instruction::shared> m_program; // running function,
      // program area
