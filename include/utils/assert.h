...
#define TS_ASSERT(condition)                                                   \
  TS_LOG((condition) ? ts::LOG_NONE : ts::LOG_FATAL)                           \
  ("Assertion failed: (")(#condition)("). ")
#define TS_CHECK(condition)                                                    \
  TS_LOG((condition) ? ts::LOG_NONE : ts::LOG_ERROR)                           \
...
#define TS_AUTO_ASSERT(condition)                                              \
  (TS_LOG((condition) ? ts::LOG_NONE : ts::LOG_FATAL)("Assertion failed: (")(  \
     #condition)(").")                                                         \
   << ts::fatal)
#define TS_AUTO_CHECK(condition)                                               \
  (TS_LOG((condition) ? ts::LOG_NONE : ts::LOG_ERROR)("Check failed: (")(      \
     #condition)(").")                                                         \
   << ts::eject)
