...
namespace ts
{
  ...
  class TS_DEBUG_API EjectionException : public Exception {
    public:
      ...
      explicit EjectionException(const std::string &message) :
        Exception(message) {}
  };
  ...
  class TS_DEBUG_API LogStream {
    public:
      ...
      self &operator<<(Method method) {
        if (m_level == LOG_NONE) return *this;
        if (m_level >= GlobalLogLevel()) { return method(*this); }
        return *this;
      }
...
#define TS_LOG(level)                                                          \
  (ts::LogStream(level))("[")(TS_LOCAL_FILE)(":")(__LINE__)("]: ")
#define TS_TIME(level) (ts::LogStream(level))("[")(ts::now_time())("]: ")
#define TS_LOG_TIME(level)                                                     \
  (ts::LogStream(level))("[")(TS_LOCAL_FILE)(":")(__LINE__)("][")(             \
    ts::now_time())("]: ")
