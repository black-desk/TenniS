...
ts_Program *ts_Program_Compile(
  ...
  std::unique_ptr<ts_Program> program(new ts_Program(Program::Compile(
...
ts_Program *ts_Program_Compile_v2(
...
ts_bool ts_Program_set_operator_param(
  ts_Program      *program,
