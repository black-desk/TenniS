...
namespace ts
{
  namespace base
  {
    ...
    void BatchToSpace4D::CaculateOutputSize(
      ...
      output_shape [2] = input_shape [2] * block_height - crop_top
                       - crop_bottom;
    ...
    int BatchToSpace4D::infer(
      ...
      TS_AUTO_CHECK(
        (input_shape [0] > 0)
        && (input_shape [0] % (m_block_shape [0] * m_block_shape [1]) == 0));
