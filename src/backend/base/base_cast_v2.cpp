...
namespace ts
{
  namespace base
  {
    ...
    CastV2::CastV2() { field(name::dtype, REQUIRED); }

    void CastV2::set_dtype(DTYPE dtype) { m_dtype = dtype; }

    DTYPE CastV2::get_dtype() const { return m_dtype; }

    void CastV2::init() { m_dtype = DTYPE(tensor::to_int(get(name::dtype))); }
