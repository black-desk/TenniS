...
namespace ts
{
  namespace tf
  {
    ...
    static inline Padding2D dynamic_pooling2d_valid(
      ...
      switch (this->m_padding_method) {
        case PaddingMethod::SAME:
          dynamic_padding = dynamic_padding_same(
            input_size, m_static_padding, ksize, stride);
          break;
        case PaddingMethod::VALID:
          dynamic_padding = dynamic_pooling2d_valid(
            input_size, m_static_padding, ksize, stride);
          break;
      }
