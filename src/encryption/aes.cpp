...
void AES_init_ctx(
  struct AES_ctx *ctx, const uint8_t *key, uint32_t key_length) {
  uint8_t default_key [32] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe,
...
void AES_init_ctx_iv(
  ...
  uint8_t default_iv [16] = { 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7,
