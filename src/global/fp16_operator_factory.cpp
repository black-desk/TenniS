...
namespace ts
{
  ...
  Fp16OperatorCreator::function Fp16OperatorCreator::Query(
  ...
  void Fp16OperatorCreator::Register(
    const DeviceType                    &device_type,
  ...
  static Fp16OperatorCreator::function TalentQuery(
    const DeviceType  &device_type,
    const std::string &operator_name,
    bool               strict) {
  ...
  Operator::shared Fp16OperatorCreator::Create(
    const DeviceType  &device_type,
    const std::string &operator_name,
  ...
  std::set<std::pair<std::string, std::string>> Fp16OperatorCreator::AllKeys()
    TS_NOEXCEPT {
