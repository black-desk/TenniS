...
namespace ts
{
  namespace cpu
  {
    namespace arm
    {
      ...
      template <typename T>
      void Conv2d3x3<T>::conv2d_3x3_s1(
        const Tensor    &x,
      ...
      template <>
      void Conv2d3x3<float>::conv2d_3x3_s1(
        const Tensor    &x,
        const Padding2D &padding,
        float            padding_value,
        const Tensor    &w,
...
#  pragma omp parallel for num_threads(openmp_threads())
          ...
          for (int m = 0; m < out_channel_bound; ++m) {
            int    mm     = m * 2;
            float *out_at = out_ptr + n * output_number_offset
                          + mm * out_channel_offset;
            float *out_ptr_0 = out_at;
            float *out_ptr_1 = out_ptr_0 + out_channel_offset;
            for (int c = 0; c < input_channel; ++c) {
              const float *kernel_at = kernel_ptr + mm * input_channel * 9
                                     + c * 9;
              const float *kernel_at_0 = kernel_at;
              const float *kernel_at_1 = kernel_at_0 + input_channel * 9;

              const float *input_at = input_ptr + n * input_number_offset
              ...
              float32x4 k00_x4(kernel_at_0), k01_x4(kernel_at_0 + 3),
                k02_x4(kernel_at_0 + 6);
              float32x4 k10_x4(kernel_at_1), k11_x4(kernel_at_1 + 3),
                k12_x4(kernel_at_1 + 6);
              ...
              for (int h = 0; h + 1 < out_height; h += 2) {
                for (int w = 0; w + 3 < out_width; w += 4) {
                  ...
                  //                                float32x4
                  //                                out00_x4(input_at_0 +
                  //                                4);//reuse out00_x4->i0n_x4
                  //                                float32x4
                  //                                i10_x4(input_at_1);
                  //                                float32x4
                  //                                out01_x4(input_at_1 + 4);
                  //                                float32x4
                  //                                i20_x4(input_at_2);
                  //                                float32x4
                  //                                out10_x4(input_at_2 + 4);
                  //                                float32x4
                  //                                i30_x4(input_at_3);
                  //                                float32x4
                  //                                out11_x4(input_at_3 + 4);
                  //
                  //                                float32x4 i01_x4 =
                  //                                concat(i00_x4, out00_x4, 1);
                  //                                float32x4 i02_x4 =
                  //                                concat(i00_x4, out00_x4, 2);
                  //                                float32x4 i11_x4 =
                  //                                concat(i10_x4, out01_x4, 1);
                  //                                float32x4 i12_x4 =
                  //                                concat(i10_x4, out01_x4, 2);
                  //                                float32x4 i21_x4 =
                  //                                concat(i20_x4, out10_x4, 1);
                  //                                float32x4 i22_x4 =
                  //                                concat(i20_x4, out10_x4, 2);
                  //                                float32x4 i31_x4 =
                  //                                concat(i30_x4, out11_x4, 1);
                  //                                float32x4 i32_x4 =
                  //                                concat(i30_x4, out11_x4, 2);
                  //
                  //                                out00_x4 = out_at_0;out01_x4
                  //                                = out_at_0 + out_width;
                  //                                out10_x4 = out_at_1;out11_x4
                  //                                = out_at_1 + out_width;
                  //#else
                  float32x4 i00_x4(input_at_0), i01_x4(input_at_0 + 1),
                    i02_x4(input_at_0 + 2);
                  float32x4 i10_x4(input_at_1), i11_x4(input_at_1 + 1),
                    i12_x4(input_at_1 + 2);
                  float32x4 i20_x4(input_at_2), i21_x4(input_at_2 + 1),
                    i22_x4(input_at_2 + 2);
                  float32x4 i30_x4(input_at_3), i31_x4(input_at_3 + 1),
                    i32_x4(input_at_3 + 2);
...
#  pragma omp parallel for num_threads(openmp_threads())
          ...
          for (int m = remain_out_channel; m < out_channel; ++m) {
            float *out_at = out_ptr + n * output_number_offset
                          + m * out_channel_offset;
            float *out_ptr_0 = out_at;

            for (int c = 0; c < input_channel; ++c) {
              const float *kernel_at = kernel_ptr + m * input_channel * 9
                                     + c * 9;
              const float *kernel_at_0 = kernel_at;
              ...
              for (int h = 0; h + 1 < out_height; h += 2) {
                for (int w = 0; w + 3 < out_width; w += 4) {
                  ...
                  //                                float32x4
                  //                                i00_x4(input_at_0);
                  //                                float32x4 i0n_x4(input_at_0
                  //                                + 4); float32x4
                  //                                i10_x4(input_at_1);
                  //                                float32x4 i1n_x4(input_at_1
                  //                                + 4); float32x4
                  //                                i20_x4(input_at_2);
                  //                                float32x4 i2n_x4(input_at_2
                  //                                + 4); float32x4
                  //                                i30_x4(input_at_3);
                  //                                float32x4 i3n_x4(input_at_3
                  //                                + 4);
                  //
                  //                                float32x4 i01_x4 =
                  //                                concat(i00_x4, i0n_x4, 1);
                  //                                float32x4 i02_x4 =
                  //                                concat(i00_x4, i0n_x4, 2);
                  //                                float32x4 i11_x4 =
                  //                                concat(i10_x4, i1n_x4, 1);
                  //                                float32x4 i12_x4 =
                  //                                concat(i10_x4, i1n_x4, 2);
                  //                                float32x4 i21_x4 =
                  //                                concat(i20_x4, i2n_x4, 1);
                  //                                float32x4 i22_x4 =
                  //                                concat(i20_x4, i2n_x4, 2);
                  //                                float32x4 i31_x4 =
                  //                                concat(i30_x4, i3n_x4, 1);
                  //                                float32x4 i32_x4 =
                  //                                concat(i30_x4, i3n_x4, 2);
                  //
                  //                                float32x4
                  //                                out00_x4(out_at_0);float32x4
                  //                                out01_x4(out_at_0 +
                  //                                out_width);
                  //#else
                  float32x4 i00_x4(input_at_0), i01_x4(input_at_0 + 1),
      ...
      template <typename T>
      void Conv2d3x3<T>::conv2d_3x3_s2(
        const Tensor    &x,
        const Padding2D &padding,
        float            padding_value,
        const Tensor    &w,
      ...
      template <>
      void Conv2d3x3<float>::conv2d_3x3_s2(
        const Tensor    &x,
        const Padding2D &padding,
        float            padding_value,
        const Tensor    &w,
            ...
            for (int c = 0; c < input_channel; ++c) {
              ...
              for (int h = 0; h < out_height; ++h) {
                for (int w = 0; w < out_width; w += 4) {
                  ...
                  float32x4 i00_x4 = i00_x4x2 [0];
                  float32x4 i01_x4 = i00_x4x2 [1];
                  float32x4 i02_x4 = concat(i00_x4, i0n_x4x2 [0], 1);
                  float32x4 i10_x4 = i10_x4x2 [0];
                  float32x4 i11_x4 = i10_x4x2 [1];
                  float32x4 i12_x4 = concat(i10_x4, i1n_x4x2 [0], 1);
                  float32x4 i20_x4 = i20_x4x2 [0];
                  float32x4 i21_x4 = i20_x4x2 [1];
                  float32x4 i22_x4 = concat(i20_x4, i2n_x4x2 [0], 1);
#else
                  float32x4 i00_x4 = inc_load(i0, 2),
                            i01_x4 = inc_load((i0 + 1), 2),
                            i02_x4 = inc_load((i0 + 2), 2);
                  float32x4 i10_x4 = inc_load(i1, 2),
                            i11_x4 = inc_load((i1 + 1), 2),
                            i12_x4 = inc_load((i1 + 2), 2);
                  float32x4 i20_x4 = inc_load(i2, 2),
                            i21_x4 = inc_load((i2 + 1), 2),
                            i22_x4 = inc_load((i2 + 2), 2);
#endif
