...
namespace ts
{
  bool FileStreamReader::is_open() const { return m_stream.is_open(); }
  ...
  void FileStreamReader::close() { m_stream.close(); }

  FileStreamReader::FileStreamReader() = default;

  bool FileStreamWriter::is_open() const { return m_stream.is_open(); }
  ...
  void FileStreamWriter::close() { m_stream.close(); }

  FileStreamWriter::FileStreamWriter() = default;

  bool FileStream::is_open() const { return m_stream.is_open(); }
  ...
  void FileStream::close() { m_stream.close(); }
