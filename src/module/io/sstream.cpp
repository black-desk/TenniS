...
namespace ts
{
  ...
  void StringStreamReader::clear() { m_stream.str(""); }
  ...
  StringStreamReader::StringStreamReader(
    const StringStreamReader::string &buffer) :
    m_stream(buffer) {}
  ...
  void StringStreamWriter::clear() { m_stream.str(""); }
  ...
  StringStreamWriter::StringStreamWriter(
    const StringStreamWriter::string &buffer) :
    m_stream(buffer) {}
  ...
  StringStream::string StringStream::str() const { return m_stream.str(); }

  void StringStream::clear() { m_stream.str(""); }
