...
template <typename T>
std::ostream &plot_set(
  std::ostream                                &out,
  const std::set<T>                           &values,
  const std::function<std::string(const T &)> &str) {
...
std::string copy(const std::string &x) { return x; }
...
std::map<std::string, std::set<std::string>> set2map(
  const std::set<std::pair<std::string, std::string>> &x) {
...
std::set<std::string> set2set_value(
  const std::set<std::pair<std::string, std::string>> &x) {
...
int main() {
  ...
  plot_set<std::pair<std::string, std::string>>(
    std::cout, hard_converter, dst_src)
    << std::endl;
  ...
  plot_set<std::pair<std::string, std::string>>(
    std::cout, computing_device, computing_memory)
    << std::endl;
